...
namespace Microsoft.eShopWeb.Web.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(ILogger<LoginModel> logger, IBasketService basketService)
        {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            ExternalLogins = new List<AuthenticationScheme>();//(await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
