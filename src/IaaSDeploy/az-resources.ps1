...
# Azure SQL Database
az sql server create -g $resourcegroup -n $sqlservername -l brazilsouth --admin-user eshopadmin --admin-password s3nh@Comple*4
...
# VM Scale Set
az vmss create -g $resourcegroup -n $scalesetname --image UbuntuLTS --upgrade-policy-mode automatic --admin-username eshopadmin --generate-ssh-keys
## DNS Name
